...
namespace DesktopHelper
{
    ...
    internal interface IVirtualDesktopManagerInternal
    {
       ...
       // void FindDesktop(ref Guid desktopId, out IVirtualDesktop ppDesktop);
    ...
    public class Desktop
    {
        ...
        public static Desktop FromWindow(IntPtr hWnd)
        {
            ...
            {
                var a = DesktopManager.VirtualDesktopManagerInternal.GetCurrentDesktop();
                return new Desktop(a);
            }
            else
            {
                IVirtualDesktop? found = null;
                DesktopManager.VirtualDesktopManagerInternal.FindDesktop(ref id);
                return new Desktop(found);
            }
