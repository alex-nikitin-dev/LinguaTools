...
namespace DesktopHelper
{
    ...
    internal static class DesktopManager
    {
        static DesktopManager()
        {
            ...
            ApplicationViewCollection =
                (IApplicationViewCollection)shell.QueryService(typeof(IApplicationViewCollection).GUID,
                    typeof(IApplicationViewCollection).GUID);
            VirtualDesktopPinnedApps =
                (IVirtualDesktopPinnedApps)shell.QueryService(Guids.CLSID_VirtualDesktopPinnedApps,
    ...
    public class Desktop
    {
        ...
        public void Remove(Desktop fallback = null)
        {
            ...
            if (fallback == null)
            {
                ...
                if (this.Equals(dtToCheck))
                {
                    ...
                    DesktopManager.VirtualDesktopManagerInternal.GetAdjacentDesktop(ivd, 4,
                        out fallbackdesktop); // 4 = RightDirection
                }
                else
                {
                    // set fallback to "left" desktop
                    DesktopManager.VirtualDesktopManagerInternal.GetAdjacentDesktop(ivd, 3,
        ...
        {
            //var buff = Encoding.Convert(Encoding.Unicode, Encoding.Unicode, Encoding.Unicode.GetBytes(name));
        ...
        public bool IsVisible
        {
            ...
            get
            {
                return object.ReferenceEquals(ivd,
        ...
        public Desktop Left
        {
            ...
            get
            {
                ...
                int hr = DesktopManager.VirtualDesktopManagerInternal
                    .GetAdjacentDesktop(ivd, 3, out desktop); // 3 = LeftDirection
                if (hr == 0)
        ...
        public Desktop Right
        {
            ...
            get
            {
                IVirtualDesktop desktop;
                int hr = DesktopManager.VirtualDesktopManagerInternal
                    .GetAdjacentDesktop(ivd, 4, out desktop); // 4 = RightDirection
                if (hr == 0)
                    return new Desktop(desktop);
                else
                    return null;
